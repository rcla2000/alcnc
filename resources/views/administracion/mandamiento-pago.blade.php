                    ...
                    <tr>
                        @foreach ($cargos as $item)
                            ...
                            <td class="text-center"><a class="btn-floating btn-sm btn-success" data-toggle="tooltip"
                                    ...
                                    class="btn-floating btn-sm btn-danger" data-toggle="tooltip" data-placement="top"
                                    title="Reducir cantidad"><i class="fas fa-minus"></i></a> <a
                                    class="btn-floating btn-sm btn-warning" data-toggle="tooltip" data-placement="top"
