...
<div class="card card-cascade narrower">
    ...
    <div
      ...
      <a href="" class="white-text mx-3">Lista de solicitudes</a>
        ...
        <table id="dtBasicExample" class="table table-hover mb-0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">  @switch($item->estado )
                  @case('Abierta')
              ...
              @endswitch {{ $item->estado }}</span></td>
              <td>{{ $item->area }}</td>
              <td class="text-center">
                <a class="btn-floating btn-sm btn-default" data-toggle="tooltip" onclick="detaSoli({{$item->id }})" data-placement="top"
                title="Ver detalles de solicitud"><i class="fas fa-eye"></i></a>

                <a class="btn-floating btn-sm btn-light-green" href="{{ route('mandamiento',  $item->id) }}" data-toggle="tooltip" data-placement="top"
                title="Procesar solicitud"><i class="fas fa-pen"></i> </a>
                </td>
