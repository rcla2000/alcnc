<div class="row">
    <div class="col-md-12">
        <h4>Fecha de ingreso de solicitud: <strong>{{ date("d/m/Y", strtotime( $solicitud->fecha_solicitud))  }} </strong></h4>
        <hr>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-5">
        Fecha de resolución: <strong>@if($solicitud->fecha_resolucion == null)
    ...
    <div class="col-md-12">
        <hr>
        Última actualizacion: <strong> @if ( $solicitud->fecha_actualizacion == null)
            Sin actualizaciones
        @else
    ...
    <div class="col-md-12">
        Usuario que actualizo: <strong> @if ( $solicitud->usuario_actualizacion == null)
            Sin actualizaciones
        @else
