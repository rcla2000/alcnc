...
<header>
        ...
        <ul class="custom-scrollbar">
            <li>
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="waves-effect {{ request()->is('dashboard') ? 'active' : '' }}"
                    ...
                    <li><a class="collapsible-header waves-effect arrow-r"><i class="far fa-eye"></i> Gestión de
                            usuarios<i class="fas fa-angle-down rotate-icon"></i></a>
                        <div class="collapsible-body">
                            <ul>
    ...
    <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg double-nav">
        ...
        <ul class="nav navbar-nav nav-flex-icons ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('home') }}"><i class="fas fa-home"></i> <span
                        class="clearfix d-none d-sm-inline-block">Inicio</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link"><i class="fas fa-bell"></i> <span
                        class="clearfix d-none d-sm-inline-block">Notificaciones</span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <a href="#" onclick="event.preventDefault();document.getElementById('close').submit()">Cerrar
                        sesión</a>
