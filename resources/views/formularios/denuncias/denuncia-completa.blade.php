...
@section('content')
    <div class="row justify-content-center mt-menu-2">
        <div class="col-12 col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- Text -->
                    <p class="card-text">Su denuncia ha sido enviada de manera éxitosa, el área correspondiente se
                        contactará en la brevedad.</p>
                    <!-- Button -->
                    <a href="{{ route('denuncia') }}" class="btn btn-primary btn-block">Regresar</a>
                </div>
            </div>
            <!-- Card -->
        </div>
